    ...
    <div className="w-full h-full bg-teal-600 text-white flex flex-col shadow-xl lg:shadow-none">
      ...
      <nav className="flex-1 p-4 overflow-hidden flex flex-col">
        <div className="space-y-1">
          ...
          {/* Resume Analyzer - Only for authenticated users */}
          {isAuthenticated && (
            <Link
              to="/instant-analyzer"
              onClick={onClose}
              className="w-full flex items-center px-3 py-2 rounded-lg transition-colors text-teal-100 hover:bg-teal-500/80 hover:text-white"
            >
              <div className="flex items-center space-x-3">
